...
__description__             = "Flux Balance Analysis using Machine Learning"
__keywords__                = ['flux', 'balance', 'analysis', 'machine', 'learning']
__url__                     = "https://github.com/achillesrasquinha/fluxml"
